...
FIXED_SIZED_DOOR_HEIGHT = 2223  # keep visible for ALL clients
...
# Always show trackset height for ALL clients
st.info(f"Trackset height: **{TRACKSET_HEIGHT}mm**")

# Only show fixed-sized door height for these housebuilders
